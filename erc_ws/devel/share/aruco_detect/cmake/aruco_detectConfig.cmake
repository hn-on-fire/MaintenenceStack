...
if("TRUE" STREQUAL "TRUE")
  set(aruco_detect_SOURCE_PREFIX /home/hn-on-fire/MRM_ERC/erc_ws/src/fiducials/aruco_detect)
  set(aruco_detect_DEVEL_PREFIX /home/hn-on-fire/MRM_ERC/erc_ws/devel)
  ...
  set(aruco_detect_INSTALL_PREFIX /home/hn-on-fire/MRM_ERC/erc_ws/install)
...
if(NOT "/home/hn-on-fire/MRM_ERC/erc_ws/devel/include;/usr/include/opencv4 " STREQUAL " ")
  set(aruco_detect_INCLUDE_DIRS "")
  set(_include_dirs "/home/hn-on-fire/MRM_ERC/erc_ws/devel/include;/usr/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aruco_detect' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hn-on-fire/MRM_ERC/erc_ws/src/fiducials/aruco_detect/${idir}'.  ${_report}")
    endif()
